...
namespace TaxiCameBack.Services.Contract
{
    public class ContactManager : IContactManager
    {
        ...
        IRepository<AddressType> _addressTypeRepository;
        IRepository<Phone> _phoneRepository;
        IRepository<PhoneType> _phoneTypeRepository;
        IRepository<ProfileAddress>_profileAddressRepository;
        IRepository<ProfilePhone> _profilePhoneRepository;
        ...
        public ContactManager(IRepository<Address> addressRepository,
                              IRepository<AddressType> addressTypeRepository,
                              IRepository<Phone> phoneRepository,
                              IRepository<PhoneType> phoneTypeRepository,
                              IRepository<ProfileAddress> profileAddressRepository,
                              IRepository<ProfilePhone> profilePhoneRepository,
...
//                throw new ArgumentException(Messages.warning_CannotAddProfileWithNullInformation);
            ...
            //Create a new profile entity
            var currentProfile = _profileRepository.GetById(id);
...
//                throw new ArgumentException(Messages.warning_CannotAddProfileWithNullInformation);
            ...
            var addressType = _addressTypeRepository.GetById(addressDTO.AddressTypeId);
...
//            {
                ...
                _profileAddressRepository.Insert(profileAddress);
...
//                throw new ApplicationValidationErrorsException(entityValidator.GetInvalidMessages(updatedAddress));
        ...
        {
            var address = _addressRepository.GetById(profileAddress.AddressId);
...
//                throw new ArgumentException(Messages.warning_CannotAddProfileWithNullInformation);
            ...
            var phoneType = _phoneTypeRepository.GetById(phoneDTO.PhoneTypeId);
...
//            {
                ...
                _profilePhoneRepository.Insert(profilePhone);
...
//                throw new ApplicationValidationErrorsException(entityValidator.GetInvalidMessages(updatedPhone));
        ...
        {
            var phone = _phoneRepository.GetById(profilePhone.PhoneId);

            if (phone != null) //if phone exist
            {
                _profilePhoneRepository.Delete(profilePhone);
                //commit changes
                _profilePhoneRepository.UnitOfWork.Commit();
