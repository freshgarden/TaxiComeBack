...
namespace TaxiCameBack.Website.Application.StorageProviders
{
    public class DiskStorageProvider : IStorageProvider
    {
        public string BuildFileUrl(params object[] subPath)
        {
            ...
            return VirtualPathUtility.ToAbsolute(string.Concat(AppConstants.UploadFolderPath, joinString));
        }
        ...
        public string GetUploadFolderPath(bool createIfNotExist, params object[] subFolders)
        {
            ...
            var folder = HostingEnvironment.MapPath(string.Concat(AppConstants.UploadFolderPath, string.Join("\\", sf)));
